...
type GetCreateOptionsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetCreateOptionsRequest) Reset() {
	*x = GetCreateOptionsRequest{}
	mi := &file_agentmuxd_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetCreateOptionsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCreateOptionsRequest) ProtoMessage() {}

func (x *GetCreateOptionsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_agentmuxd_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCreateOptionsRequest.ProtoReflect.Descriptor instead.
func (*GetCreateOptionsRequest) Descriptor() ([]byte, []int) {
	return file_agentmuxd_proto_rawDescGZIP(), []int{13}
}

type GetCreateOptionsResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	DefaultHostName string                 `protobuf:"bytes,1,opt,name=default_host_name,json=defaultHostName,proto3" json:"default_host_name,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *GetCreateOptionsResponse) Reset() {
	*x = GetCreateOptionsResponse{}
	mi := &file_agentmuxd_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetCreateOptionsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCreateOptionsResponse) ProtoMessage() {}

func (x *GetCreateOptionsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_agentmuxd_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCreateOptionsResponse.ProtoReflect.Descriptor instead.
func (*GetCreateOptionsResponse) Descriptor() ([]byte, []int) {
	return file_agentmuxd_proto_rawDescGZIP(), []int{14}
}

func (x *GetCreateOptionsResponse) GetDefaultHostName() string {
	if x != nil {
...
const file_agentmuxd_proto_rawDesc = "" +
	...
	"\x17GetCreateOptionsRequest\"F\n" +
	"\x18GetCreateOptionsResponse\x12*\n" +
	"\x11default_host_name\x18\x01 \x01(\tR\x0fdefaultHostName\"S\n" +
...
var file_agentmuxd_proto_goTypes = []any{
	...
	(*GetCreateOptionsRequest)(nil),       // 16: agentmuxd.v1.GetCreateOptionsRequest
	(*GetCreateOptionsResponse)(nil),      // 17: agentmuxd.v1.GetCreateOptionsResponse
	(*ListResumableSessionsRequest)(nil),  // 18: agentmuxd.v1.ListResumableSessionsRequest
	(*ResumableSession)(nil),              // 19: agentmuxd.v1.ResumableSession
...
var file_agentmuxd_proto_depIdxs = []int32{
	...
	19, // 7: agentmuxd.v1.ListResumableSessionsResponse.sessions:type_name -> agentmuxd.v1.ResumableSession
