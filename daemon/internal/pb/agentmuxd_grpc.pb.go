...
type AgentmuxDaemonClient interface {
	...
	GetCreateOptions(ctx context.Context, in *GetCreateOptionsRequest, opts ...grpc.CallOption) (*GetCreateOptionsResponse, error)
	...
	ViewPane(ctx context.Context, in *ViewPaneRequest, opts ...grpc.CallOption) (*ViewPaneResponse, error)
...
func (c *agentmuxDaemonClient) GetCreateOptions(ctx context.Context, in *GetCreateOptionsRequest, opts ...grpc.CallOption) (*GetCreateOptionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCreateOptionsResponse)
	err := c.cc.Invoke(ctx, AgentmuxDaemon_GetCreateOptions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentmuxDaemonClient) ViewPane(ctx context.Context, in *ViewPaneRequest, opts ...grpc.CallOption) (*ViewPaneResponse, error) {
	...
	err := c.cc.Invoke(ctx, AgentmuxDaemon_ViewPane_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentmuxDaemonClient) SendKeys(ctx context.Context, in *SendKeysRequest, opts ...grpc.CallOption) (*SendKeysResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendKeysResponse)
	err := c.cc.Invoke(ctx, AgentmuxDaemon_SendKeys_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentmuxDaemonServer interface {
	...
	// Returns host-derived defaults used by the interactive creation wizard.
	GetCreateOptions(context.Context, *GetCreateOptionsRequest) (*GetCreateOptionsResponse, error)
	// Lists Claude Code session IDs resumable for a given workdir, for the
	// wizard's resume picker.
	...
	// if you attached and looked, without opening an interactive session.
	// Read-only; safe to call at any time.
	ViewPane(context.Context, *ViewPaneRequest) (*ViewPaneResponse, error)
	// Headless equivalent of typing into an instance's pane — what Attach
	// would send as stdin, without opening an interactive session. Scriptable
	// access to the same capability Attach already grants interactively, so
	// it carries the same trust assumption: anyone who can call this can type
...
func (UnimplementedAgentmuxDaemonServer) GetCreateOptions(context.Context, *GetCreateOptionsRequest) (*GetCreateOptionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCreateOptions not implemented")
}
...
func _AgentmuxDaemon_GetCreateOptions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCreateOptionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentmuxDaemonServer).GetCreateOptions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentmuxDaemon_GetCreateOptions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentmuxDaemonServer).GetCreateOptions(ctx, req.(*GetCreateOptionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AgentmuxDaemon_ViewPane_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AgentmuxDaemonServer).ViewPane(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentmuxDaemon_ViewPane_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentmuxDaemonServer).ViewPane(ctx, req.(*ViewPaneRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AgentmuxDaemon_SendKeys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendKeysRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentmuxDaemonServer).SendKeys(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentmuxDaemon_SendKeys_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentmuxDaemonServer).SendKeys(ctx, req.(*SendKeysRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AgentmuxDaemon_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCreateOptions",
			Handler:    _AgentmuxDaemon_GetCreateOptions_Handler,
		},
		{
		...
		{
			MethodName: "ViewPane",
			Handler:    _AgentmuxDaemon_ViewPane_Handler,
		},
		{
			MethodName: "SendKeys",
